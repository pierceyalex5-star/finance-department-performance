...
CREATE TABLE IF NOT EXISTS projects (
  ...
  UNIQUE(workspace_id,context,name)
);
...
ALTER TABLE notes ADD COLUMN IF NOT EXISTS context text NOT NULL DEFAULT 'work';
...
ALTER TABLE memory_entries ADD COLUMN IF NOT EXISTS context text NOT NULL DEFAULT 'work';
...
ALTER TABLE chat_messages ADD COLUMN IF NOT EXISTS context text NOT NULL DEFAULT 'work';
CREATE INDEX IF NOT EXISTS idx_chat_workspace_created ON chat_messages(workspace_id,created_at DESC);
CREATE INDEX IF NOT EXISTS idx_chat_workspace_context_created ON chat_messages(workspace_id,context,created_at DESC);
...
ALTER TABLE activity_log ADD COLUMN IF NOT EXISTS context text NOT NULL DEFAULT 'work';
